...
**Details of the Incident and Actions Taken** <br>
...
**Notification to Regulatory Authorities:** <br>
...
**Incident Response Details- Detection, Analysis & Containment:** <br>
...
in order to mitigate any additional risk at the data center Red&Blue enforced several precautions and implemented security best practices.  <br>
1.	As an official patch has not been released by the vendor, we have disabled a few vulnerable ports and protocols related to the remote management software. And also increase network segmentation for the server’s security. <br>
